...
const urlsToCache = [
  ...
  '/lisbleubylili/vendor/react.production.min.js',
  '/lisbleubylili/vendor/react-dom.production.min.js',
  '/lisbleubylili/vendor/babel.min.js',
  '/lisbleubylili/vendor/bcrypt.min.js',
  '/lisbleubylili/vendor/tailwind-browser.js',
  '/lisbleubylili/vendor/lucide/lucide.css',
  '/lisbleubylili/vendor/lucide/lucide.woff2',
  '/lisbleubylili/utils/push-config.js',
  '/lisbleubylili/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/lisbleubylili/icons/icon-192x192.png',
    badge: '/lisbleubylili/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/lisbleubylili/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/lisbleubylili/admin.html';
  event.waitUntil(
